    ...
    <div className="max-w-[1680px] mx-auto p-4 lg:p-8 space-y-8 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-[#0c1222]/90 border border-slate-800/80 p-6 rounded-3xl backdrop-blur-md shadow-xl">
        <div className="flex items-center gap-4">
          <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shadow-lg ring-1 ring-white/20 transition-all ${
            activeTab === 'weight'
      ...
      <div className="flex items-center gap-2.5 border-b border-slate-800 pb-2">
          ...
          {weights.length > 0 && (
            <span
              className={`px-1.5 py-0.5 rounded-md text-[10px] font-bold ${
                activeTab === 'weight' ? 'bg-white/20 text-white' : 'bg-slate-800 text-slate-400'
              }`}
            >
              {weights.length}
            </span>
        ...
        >
          ...
          {measures.length > 0 && (
            <span
              className={`px-1.5 py-0.5 rounded-md text-[10px] font-bold ${
                activeTab === 'measures' ? 'bg-white/20 text-white' : 'bg-slate-800 text-slate-400'
              }`}
            >
              {measures.length}
            </span>
      ...
      <>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-[#0c1222]/90 border border-slate-800 p-5 rounded-3xl shadow-xl relative overflow-hidden group hover:border-slate-700 transition-all">
            ...
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Cintura Atual</span>
              <div className="w-8 h-8 rounded-xl bg-cyan-500/10 text-cyan-400 flex items-center justify-center border border-cyan-500/20">
                <Ruler className="w-4 h-4" />
              </div>
            </div>
          ...
          <div className="bg-[#0c1222]/90 border border-slate-800 p-5 rounded-3xl shadow-xl relative overflow-hidden group hover:border-slate-700 transition-all">
            ...
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Abdômen Atual</span>
              <div className="w-8 h-8 rounded-xl bg-amber-500/10 text-amber-400 flex items-center justify-center border border-amber-500/20">
                <Ruler className="w-4 h-4" />
              </div>
            </div>
        ...
        <div className="bg-[#0c1222]/90 border border-slate-800 rounded-3xl p-6 shadow-xl space-y-4">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 pb-2 border-b border-slate-800/80">
            <div>
              <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-4 text-xs font-semibold text-slate-400 px-1">
            {(measureChartFilter === 'both' || measureChartFilter === 'cintura') && (
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-cyan-400 ring-2 ring-cyan-500/30" />
                <span className="text-cyan-300 font-bold">Cintura (cm)</span>
              </div>
            )}
            {(measureChartFilter === 'both' || measureChartFilter === 'abdomen') && (
              <div className="flex items-center gap-2">
                ...
                <span className="text-amber-300 font-bold">Abdômen (cm)</span>
              </div>
            )}
          </div>
          ...
          {isLoading ? (
            ...
            <div className="relative w-full overflow-hidden">
              ...
              {hoveredMeasurePoint && (() => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between gap-3 text-slate-400 text-[10px] font-bold uppercase">
                      <span className={isCintura ? 'text-cyan-400' : 'text-amber-400'}>
            ...
            <div className="h-56 flex flex-col items-center justify-center gap-3 text-slate-500 border border-dashed border-slate-800 rounded-2xl">
              <Ruler className="w-8 h-8 text-slate-600" />
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-base font-extrabold text-white flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-slate-400">({measures.length} registros)</span>
              </h2>
              <p className="text-xs text-slate-400">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full sm:w-auto">
              ...
              <div className="relative w-full sm:w-64">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-1.5 rounded-xl bg-slate-900 border border-slate-700 text-white text-xs placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/50"
                />
              </div>
            </div>
          </div>
                    ...
                    return (
                      <tr key={item.id} className="hover:bg-slate-900/40 transition-colors">
                        ...
                        <td className="py-3.5 px-4 font-extrabold text-white">
                          ...
                          <span className="text-slate-400 text-xs ml-1 font-normal">cm</span>
                        </td>
            ...
            <form onSubmit={handleSaveMeasure} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-300 mb-1.5">
                  Tipo de Medida <span className="text-rose-400">*</span>
                </label>
              ...
              <div>
                <label className="block text-xs font-bold text-slate-300 mb-1">
                  Medida em cm <span className="text-rose-400">*</span>
                </label>
                <div className="relative">
                  <input
                    type="text"
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900 border border-slate-700 text-white font-black text-lg focus:outline-none focus:ring-2 focus:ring-cyan-500/50"
                  />
                  <span className="absolute right-3.5 top-1/2 -translate-y-1/2 font-bold text-sm text-slate-400">
                    cm
                  </span>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 rounded-xl bg-slate-900 border border-slate-700 text-white text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/50"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2 rounded-xl bg-slate-900 border border-slate-700 text-white text-xs focus:outline-none focus:ring-2 focus:ring-cyan-500/50 resize-none"
                />
              </div>
      ...
      {isTelegramModalOpen && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-[#0b101e] border border-slate-700 rounded-3xl max-w-xl w-full shadow-2xl p-6 space-y-6 animate-in fade-in zoom-in-95 my-8">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Registre suas pesagens e medidas por mensagem no celular</p>
                </div>
              </div>
              <button
                type="button"
            ...
            {telegramStatus?.isBotActive && (
              <div className="space-y-4 p-4 rounded-2xl bg-gradient-to-tr from-cyan-950/20 to-slate-900/60 border border-cyan-500/20">
                <div className="flex items-center gap-2">
                ...
                <div className="mt-3 p-3.5 bg-slate-950/80 rounded-xl border border-slate-800 space-y-3">
                  ...
                  <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 space-y-1">
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] font-bold text-slate-400 uppercase">1. Registro de Peso</span>
                      <code className="text-emerald-400 font-mono font-bold text-xs">Peso: 93,5</code>
                    </div>
                  ...
                  <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 space-y-1">
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] font-bold text-slate-400 uppercase">2. Registro de Cintura</span>
                      <code className="text-cyan-400 font-mono font-bold text-xs">Cintura: 97,5</code>
                    </div>
                    <p className="text-[11px] text-slate-300 italic">
                  ...
                  <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 space-y-1">
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] font-bold text-slate-400 uppercase">3. Registro de Abdômen</span>
                      <code className="text-amber-400 font-mono font-bold text-xs">Abdmomen: 106,5</code>
                    </div>
                  ...
                  {/* Comandos Rápidos */}
                  <div className="pt-2 border-t border-slate-800 text-[10px] text-slate-400 flex flex-wrap gap-2">
                    <span className="font-bold text-slate-300">Comandos:</span>
                    <code className="text-slate-300 bg-slate-900 px-1 py-0.5 rounded">/peso</code>
                    <code className="text-cyan-300 bg-slate-900 px-1 py-0.5 rounded">/cintura</code>
                    <code className="text-amber-300 bg-slate-900 px-1 py-0.5 rounded">/abdomen</code>
                    <code className="text-slate-300 bg-slate-900 px-1 py-0.5 rounded">/ajuda</code>
                  </div>
                </div>
              </div>
            )}
